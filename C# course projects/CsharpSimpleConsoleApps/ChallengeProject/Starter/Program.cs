...
foreach (string name in studentNames)
{
    ...
    decimal currentStudentExtraCreditImpact = 0;
    ...
    sumAssignmentScores = sumExamScore + (decimal)sumExtraCreditScore / 10;
    ...
    int extraAssignments = gradedAssignments - examAssignments;

    currentStudentExamScore = (decimal)(sumExamScore) / examAssignments;
    currentStudentExtraCreditScore = (decimal)(sumExtraCreditScore) / extraAssignments;
    currentStudentExtraCreditImpact = currentStudentOverallGrade - currentStudentExamScore;


    // Student         Exam Score      Overall Grade   Extra Credit
    // Sophia          92.2            95.88   A       92 (3.68 pts)

    Console.WriteLine($"{currentStudent}\t\t{currentStudentExamScore}\t\t{currentStudentOverallGrade}\t{currentStudentLetterGrade}\t{currentStudentExtraCreditScore} ({currentStudentExtraCreditImpact} pts)");
}
